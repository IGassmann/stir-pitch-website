...
const Summary = () => (
  <SummaryContainer>
    ...
    <p>
      I want to work alongisde people that are passionate about resolving problems for creators and that really understand them. I believe there's still a lot to be built in the creator space to satisfy the growing needs of creators and Stir is leading the way with its team and mission-driven approach.
    </p>
  </SummaryContainer>
);
